<?php  filters ?>
<div class="col-xs-12 col-sm-4 col-sm-offset-8 col-md-4 col-md-offset-8 col-lg-3 col-lg-offset-9 buttons-gallery">
	<div class="button button-filters closed">Filters</div>
</div>
<div class="closed hidden filters-menu">
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-6 col-lg-5 col-lg-offset-7 filters-list">
			<div id="options">
				<?php
