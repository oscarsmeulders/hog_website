<?php
/**
 * 	Template Name: Overview - merken
 *
 *	This page is the template for a overview - van alle merken.
 *
*/
get_header(); ?>
</head>
...
<div class="main">
	<div class="container-fluid container-filters">
		<div class="row">
			<?php get_template_part( '/lib/parts/filters_merken', '' ); ?>
		</div>
	</div>
			...
			if ( $loop->have_posts() ) :
				...
				while ( $loop->have_posts() ) : $loop->the_post();
					...
					if ($count == $count_where - 1 && $count_where != 0):
						$output .= add_contact_to_output_branches(); // add contact in overview
					endif;
					$output .='
						<div class="item isotope-item '. custom_taxonomies_merken_page() .'">
							<div>
