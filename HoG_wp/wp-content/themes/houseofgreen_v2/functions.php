...
function custom_dashboard_help_beelden() {
	echo '<p>
		...
		<tbody>
			...
			<tr>
				<td valign="top">
					RGB, 72dpi<br/><br/>
					Minimaal 2000px als de breedste maat, dwz
					<ol>
						<li>Verhouding 2:1 (breedte:hoogte).<br/>Moet het beeld minimaal 2000px breed zijn</li>
						<li>Verhouding 1:2 (breedte:hoogte).<br/>Moet het beeld minimaal 2000px hoog zijn</li>
					</ol>
					Heb je geen beeld van 2000px dan kun je deze nog altijd in het systeem zetten,
					maar is de kwaliteit misschien wat minder. Elk beeld wat in Wordpress word gezet wordt automatisch uitgesneden naar vier verhoudingen:
					<ol>
						<li>Verhouding 2:1</li>
						<li>Verhouding 1:2</li>
						<li>Verhouding 1:1</li>
						<li>Verhouding 4:3</li>
					</ol>
					Je hoeft dus niet voor ieder beeld al deze verhoudingen te maken. Dit hoef je alleen te doen als je niet blij wordt van de automatische uitsnede van Wordpress.
					Wordpress snijd alle beelden namelijk altijd vanuit het midden en vaak is dit niet de optimale snede.
				</td>
			</tr>
			<tr>
				<td valign="top">
					<br/><a href="wp-admin/upload.php">Voeg hier de beelden toe aan Wordpress.</a>
				</td>
			</tr>
...
function custom_dashboard_help_beelden_2() {
	echo '<p>
		<table style="width:100%">
		<thead>
			<tr>
				<td style="font-weight:600">PAGINA&nbsp;</td>
			</tr>
		</thead>
		<tbody>
			<tr>
			<td valign="top">
			Elke pagina heeft een thumbnail beeld nodig in de website. Deze thumbnails komen o.a. tevoorschijn bij zoekresultaten en bij de andere overviews. Een thumbnail heeft als verhouding 4:3 (ook deze weer liefst minimaal 2000px breed).
			</td>
			</tr>
		</tbody>
		</table>
		...
		<thead>
			<tr>
				<td style="font-weight:600">SLIDESHOW&nbsp;</td>
			</tr>
		</thead>
		<tbody>
			<tr>
			<td valign="top">
			Een slidehow is overal te gebruiken dwz Onze projecten of Onze merken maar ook gewone paginas kunnen een slideshow krijgen.<br/>
			Mogelijke verhoudingen:
			<ol>
				<li>Verhouding 2:1</li>
				<li>Verhouding 1:2</li>
			...
			<strong>LET OP</strong> een slideshow moet minimaal 4 beelden bevatten om mooi te werken.
			Desnoods als je maar twee beelden hebt, gaan we deze twee beelden 2 keer in de slideshow zetten.
			</td>
			</tr>
		</tbody>
		</table>
...
function create_branch_kind() {
	register_taxonomy(
		'branch_kind_category',
		'branch_kind_category',
		array(
			'label' => __( 'wp_menu_label_branch_kind_category', 'hog_lang' ),
			'rewrite' => array( 'slug' => 'branch-kind-category' ),
			'hierarchical' => true
		)
	);
}
add_action( 'init', 'create_branch_kind' );
...
function create_post_type_branch() {
	register_post_type( 'branch_item',
		array(
			'labels' => array(
				'name' => __( 'wp_menu_branch','hog_lang' ),
				'singular_name' => __( 'wp_menu_branch','hog_lang' ),
				'add_new' => __( 'wp_menu_branch_new','hog_lang' ),
			),
			'public' => true,
			'has_archive' => false,
			'taxonomies' => array('branch_kind_category'),
			'rewrite' => array('slug'=> __( 'wp_menu_branch_slug','hog_lang' ), 'with_front'=>false),
			'menu_icon' => 'dashicons-format-aside'
		)
	);
}
add_action( 'init', 'create_post_type_branch' );
...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Overview Settings',
		'menu_title'	=> 'Overview page',
		'parent_slug'	=> 'theme-general-settings',
	));
